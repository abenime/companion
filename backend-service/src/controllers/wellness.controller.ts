...
export class WellnessController {
    ...
    public static async getDailyFeatures(req: any, res: Response): Promise<void> {
        ...
        try {
            ...
            const features = await FeatureExtractionService.computeUserDailyFeatures(userId, targetDate);
    ...
    public static async runAIInference(req: any, res: Response): Promise<void> {
        const userId = req.userId;
    ...
    public static async getPredictionsTimeline(req: any, res: Response): Promise<void> {
        const userId = req.userId;
        const db = DatabaseConnection.getInstance();
    ...
    public static async deleteTodayLogs(req: any, res: Response): Promise<void> {
        const userId = req.userId;
        const db = DatabaseConnection.getInstance();
    ...
    public static async purgeAllLogs(req: any, res: Response): Promise<void> {
        const userId = req.userId;
        const db = DatabaseConnection.getInstance();
        const client = await db.getClient();
