...
function createMockRequest(body = {}, query = {}, userId) {
    return {
        body,
        query,
        userId,
...
async function runTests() {
    ...
    try {
        ...
        await auth_controller_1.AuthController.register(regReq, regRes);
        ...
        await signal_controller_1.SignalController.ingestMobile(mobReq, mobRes);
        ...
        const features = await feature_extractor_service_1.FeatureExtractionService.computeUserDailyFeatures('mock-user-uuid', new Date());
        ...
        await wellness_controller_1.WellnessController.getDailyFeatures(scoreReq, scoreRes);
